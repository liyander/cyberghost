...
export default function CtfWins(){return <div className="page-wrap awards-page"><a className="skip-link" href="#main-content">Skip to content</a><Defaultnavbar/><main id="main-content" tabIndex={-1} className="page-main">
