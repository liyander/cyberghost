...
import React from 'react'; import Defaultnavbar from './navbar'; import './site.css'; import './inner-pages.css';
const notes=[
...
export default function Writeups(){return <div className="page-wrap notes-page"><a className="skip-link" href="#main-content">Skip to content</a><Defaultnavbar/><main id="main-content" tabIndex={-1} className="page-main">
