...
const certData = [
  ...
  { img: junior, title: "Junior Penetration Tester", desc: "Tryhackme", icon: "🧪",src:"https://www.codedex.io/images/javascript/javascript-course-banner.gif",level:"Intermediate" },
  ...
  { img: advent, title: "Advent of Cyber", desc: "TryHackMe Event", icon: "🎄",src:"https://i.imgur.com/If0k6Qj.gif",level:"intermediate" },
  ...
  { img: prevesc, title: "Privilege Escalation", desc: "TCM Security", icon: "🧗",src:"https://www.codedex.io/images/numpy/banner.gif",level:"intermediate" },
  { img: osint, title: "OSINT Fundamentals", desc: "TCM Security", icon: "🔍",src:"https://cdn.wallpapersafari.com/26/68/CK7JQZ.jpg",level:"intermediate" },
  { img: soc, title: "SOC 101", desc: "TCM Security", icon: "🚨",src:"https://cdn.wallpapersafari.com/15/68/UEROHP.jpg",level:"intermediate" },
  { img: webhack, title: "Practical Web Hacking", desc: "TCM Security", icon: "🌐",src:"https://cdn.wallpapersafari.com/38/73/zVLwet.jpg",level:"intermediate" },
  ...
  { img: forensics, title: "Cyber Forensics", desc: "TCM Security", icon: "🧬",src:"https://cdn.wallpapersafari.com/17/79/mu3Ahd.jpg",level:"intermediate" },
  { img: hackquest, title: "HackQuest", desc: "National CTF 2nd Runner", icon: "🏆",src:"https://cdn.wallpapersafari.com/96/83/YPhQn8.jpg",level:"intermediate" },
